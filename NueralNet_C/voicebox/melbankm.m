...
k2_=find(fp>0,1);   % FFT bin_1 k2+b1 is the first to contribute to both upper and lower filters
k2 = k2_(1);

k3_=find(fp<p,1,'last');  % FFT bin_1 k3+b1 is the last to contribute to both upper and lower filters
k3 = k3_(1);
