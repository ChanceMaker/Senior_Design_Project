 ...
 * C/C++ source code generated on  : 12-Apr-2018 01:28:53
 */
...
static void main_melfunction(double *);
double * getData();
 ...
 * Return Type  : void
 */
static void main_melfunction(double * dataAry)
{
